...
/**
 * Class for time helper functions.
 */
class TimeHelper {
  /**
   ...
   */
  static substractOneDay(originalDate) {
   ...
   */
  static addHours(originalDate, numberOfHours) {
   ...
   */
  static bisectDate(dataset, reference) {
